...
public class deleteFolder extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Delete Files ");
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(deleteFolder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new deleteFolder().setVisible(true);
            }
        });
    }
